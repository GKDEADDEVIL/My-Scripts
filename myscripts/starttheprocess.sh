...
sudo apt install sublist3r dirb feroxbuster ffuf tmux gedit set recon-ng assetfinder vim beef amass konsole gnome-terminal git httprobe wfuzz wifite htop etherape 
